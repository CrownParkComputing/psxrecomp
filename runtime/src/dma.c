    ...
    if (dma_cdrom_transfer_active()) {
        ...
        if (direction != 0) {
            ...
            if (a->remaining_words == a->total_words && words_budget > 0 &&
                ...
                if (bytes > PSX_MAIN_RAM_BYTES - addr)
                    bytes = PSX_MAIN_RAM_BYTES - addr;
