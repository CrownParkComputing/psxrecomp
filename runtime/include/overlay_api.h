...
/* (PGXP, no ABI bump): OverlayCallbacks grew an appended-last PGXPHooks
 ...
 *  11: + destructive/equal-value GPR provenance barriers, including link and
 *      synthetic writes; PGXPHooks gains its codegen-guarded gpr_written
 *      callback. */
